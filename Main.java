...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        album.addSong("Jaan Hai Meri",4.5);
        album.addSong("Dilbar",3.5);
        album.addSong("Tum Prem Ho",5.0);
        albums.add(album);
        ...
        albums.get(0).addToPlayList("Jaan Hai Meri",playList_1);
        albums.get(0).addToPlayList("Dilbar",playList_1);
